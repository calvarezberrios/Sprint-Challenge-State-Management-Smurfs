            ...
            <CardContent>
                ...
                {!isEditing ? ( <>
                    ...
                    (<form>
                        ...
                        <input id = "name" type= "text" name = "name" value = {values.name} onChange = {handleChanges} /><br />
                        <label htmlFor = "name">Age:</label>
                        <input id = "age" type= "number" name = "age" value = {values.age} onChange = {handleChanges} /><br />
